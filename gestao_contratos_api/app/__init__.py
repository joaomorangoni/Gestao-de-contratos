...
def create_app():
    ...
    # Alguns provedores usam postgres://; SQLAlchemy 2 espera postgresql://.
    ...
    app.register_blueprint(reviewed_bp, url_prefix="/api/reviewed-contracts")
    ...
    def health():
        return jsonify({
            ...
            "status": "ok",
            "endpoints": ["/api/auth", "/api/users", "/api/contracts", "/api/reviewed-contracts"],
        })
